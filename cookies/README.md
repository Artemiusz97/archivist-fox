...
Drop platform-specific Netscape-format cookie files here to download age-restricted, login-only, or high-res content without site conflicts:

- `youtube.txt` - YouTube login cookies (for age-restricted videos/shorts)
